...
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "<query>" --domain <domain>
```

On this machine `python`/`python3` are broken Microsoft Store aliases - use `py -3` (Python 3.14.2). Paths are relative to the project root. Requires Python 3.x, no external dependencies (see README for install instructions if Python is missing).
...
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --stack <stack>
```
...
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "keyboard focus modal" --domain ux

# Step 4: stack guidelines
py -3 ".claude/skills/ui-ux-pro-max/scripts/search.py" "suspense streaming bundle" --stack nextjs
```
