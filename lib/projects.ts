...
export const projects: Project[] = [
  ...
  // ─────────────────────────────────────────────── §F · Trading Operations ──
  {
    ...
    screenshots: [
      {
        src: "/work/trading-operations/landing.webp",
        alt: "SMC Trading Platform landing page — from enquiry to payment, without the paperwork",
        caption: "Landing page",
        width: 1402,
        height: 895,
      },
      {
        src: "/work/trading-operations/lifecycle.webp",
        alt: "The eighteen-step trading lifecycle compressed into six phases",
        caption: "The 18-step lifecycle",
        width: 1468,
        height: 568,
      },
      {
        src: "/work/trading-operations/quote-comparison.webp",
        alt: "Quote comparison ranking vendors by effective cost, alongside the backend-authority rule",
        caption: "Quote comparison",
        width: 1362,
        height: 648,
      },
      {
        src: "/work/trading-operations/dashboard.webp",
        alt: "Role dashboard showing open enquiries, items in fulfilment, awaiting payment and overdue",
        caption: "Dashboard",
        width: 1600,
        height: 764,
      },
      {
        src: "/work/trading-operations/enquiries.webp",
        alt: "Enquiry list for the selected company with status and next action",
        caption: "Enquiries",
        width: 1600,
        height: 764,
      },
      {
        src: "/work/trading-operations/enquiry-detail.webp",
        alt: "Enquiry detail at stage 2 of 18, recording vendor quotes from an uploaded document",
        caption: "Enquiry detail",
        width: 1600,
        height: 756,
      },
      {
        src: "/work/trading-operations/archive.webp",
        alt: "Archive of won, lost, open and expired enquiries with full history",
        caption: "Archive",
        width: 1600,
        height: 759,
      },
      {
        src: "/work/trading-operations/status-board.webp",
        alt: "Live project status board, auto-refreshing, replacing the manual daily update sheet",
        caption: "Live status board",
        width: 1600,
        height: 762,
      },
      {
        src: "/work/trading-operations/customers.webp",
        alt: "Customer master data with payment terms, CRV requirement and credit limits",
        caption: "Customers",
        width: 1600,
        height: 751,
      },
      {
        src: "/work/trading-operations/suppliers.webp",
        alt: "Supplier records with currency, terms, categories and lead times",
        caption: "Suppliers",
        width: 1600,
        height: 759,
      },
      {
        src: "/work/trading-operations/items.webp",
        alt: "Item catalogue across every enquiry, grouped by category",
        caption: "Item catalogue",
        width: 1600,
        height: 758,
      },
      {
        src: "/work/trading-operations/reports.webp",
        alt: "Reporting across receivables, revenue, GST summary and per-order margin",
        caption: "Reports",
        width: 1600,
        height: 759,
      },
      {
        src: "/work/trading-operations/financials.webp",
        alt: "Financial movement — received, paid out, net movement and receipts for the period",
        caption: "Financial movement",
        width: 1600,
        height: 759,
      },
    ],
