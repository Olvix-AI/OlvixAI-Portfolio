...
// Section 8 — "Capabilities & stack": row 1 is what we build, row 2 is what we build it with.
...
export function IntegrationsSection() {
  ...
  return (
    <section id="stack" ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
      ...
      {/* Full-width marquees outside container — row 1: capabilities */}
